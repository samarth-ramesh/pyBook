...
\end{quotation}
For those who have never programmed in their lives, Python offers an easy in, as the language is very easy to both read and use.
...
\begin{quote}\emph{
lorem ipsum dor\\ must add windows output}
\end{quote}
...
In Python 3, the statement \emph{print()} is used to print a statement, with statement in \emph{either} single \emph{or} double quotes.in other words,
