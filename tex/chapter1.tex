...
Hello World!
\end{quote}
In Python 3, the statement \emph{print()} was used to print a statement, in our case a string which was enclosed in double quotes.It is also important to note that in Python 3, \emph{print()} statement will automaticaly generate a newline upon printing all the statements passed to it.
